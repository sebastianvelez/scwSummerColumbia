...
Aplying functions to columns or rows is as easy as
...
- Calculate the mean and stadard deviation for Miles Davis' sales for US and non-US markets separately.
...
- Suppose we want to work only with planets thta have rings. 
